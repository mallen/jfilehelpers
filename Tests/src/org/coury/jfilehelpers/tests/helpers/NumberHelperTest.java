...
public class NumberHelperTest {
	...
	public void convertStringToInteger(){
		String s = "123";
		Number converted = NumberHelper.convertStringToNumber(s, Integer.TYPE);
		assertEquals(123, converted);
		assertTrue(converted.getClass().getName().equals("java.lang.Integer"));
	}
	
	@Test
	public void convertStringToInteger2(){
		String s = "123";
		Number converted = NumberHelper.convertStringToNumber(s, Integer.class);
		assertEquals(123, converted);
		assertTrue(converted.getClass().getName().equals("java.lang.Integer"));
	}
	...
	public void convertStringToLong(){
		String s = "123";
		Number converted = NumberHelper.convertStringToNumber(s, Long.TYPE);
		assertEquals(123L, converted);
		assertTrue(converted.getClass().getName().equals("java.lang.Long"));
	}
	
	@Test
	public void convertStringToLong2(){
		String s = "123";
		Number converted = NumberHelper.convertStringToNumber(s, Long.class);
		assertEquals(123L, converted);
		assertTrue(converted.getClass().getName().equals("java.lang.Long"));
	}
	...
	public void convertStringToFloat(){
		String s = "123.456";
		Number converted = NumberHelper.convertStringToNumber(s, Float.TYPE);
		assertEquals(123.456F, converted);
		assertTrue(converted.getClass().getName().equals("java.lang.Float"));
	}
	
	@Test
	public void convertStringToFloat2(){
		String s = "123.456";
		Number converted = NumberHelper.convertStringToNumber(s, Float.class);
		assertEquals(123.456F, converted);
		assertTrue(converted.getClass().getName().equals("java.lang.Float"));
	}
	...
	public void convertStringToDouble(){
		String s = "123.456";
		Number converted = NumberHelper.convertStringToNumber(s, Double.TYPE);
		assertEquals(123.456, converted);
		assertTrue(converted.getClass().getName().equals("java.lang.Double"));
	}
	
	@Test
	public void convertStringToDouble2(){
		String s = "123.456";
		Number converted = NumberHelper.convertStringToNumber(s, Double.class);
		assertEquals(123.456, converted);
		assertTrue(converted.getClass().getName().equals("java.lang.Double"));
	}
	...
	public void convertStringToBigDecimal(){
		String s = "123.456";
		Number converted = NumberHelper.convertStringToNumber(s, BigDecimal.class);
		assertEquals(new BigDecimal(s), converted);
		assertTrue(converted.getClass().getName().equals("java.math.BigDecimal"));
	}
