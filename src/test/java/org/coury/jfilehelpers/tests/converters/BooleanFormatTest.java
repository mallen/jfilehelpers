...
public class BooleanFormatTest {
	...
	public void test1() throws IOException{
		...
		List<BooleanType> res = engine.readResource("/Good/BooleanTest1.txt");
	...
	public void test2() throws IOException{
		...
		List<BooleanType> res = engine.readResource("/Good/BooleanTest2.txt");
	...
	public void test3() throws IOException{
		...
		List<BooleanTypeWithOptions> res = engine.readResource("/Good/BooleanTest2.txt");
